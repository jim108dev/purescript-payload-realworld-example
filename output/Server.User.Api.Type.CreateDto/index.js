...
var showCreateDto = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericCreateDto)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
    ...
    return "username";
}))(Data_Show.showRecordFieldsNil)(Shared_Type_ShortString.showShortString))(Shared_Type_ShortString.showShortString))(Data_Maybe.showMaybe(Shared_Type_LongString.showLongString)))(Shared_Type_ShortString.showShortString))(Data_Maybe.showMaybe(Shared_Type_LongString.showLongString)))))))(new Data_Symbol.IsSymbol(function () {
    return "CreateDto";
}))));
...
var encodeCreateDto = new Foreign_Generic_Class.Encode(Foreign_Generic.genericEncode(genericCreateDto)(Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
    ...
    return "image";
}))(Foreign_Generic_Class.encodeWithOptionsOther(Foreign_Generic_Class.maybeEncode(Shared_Type_LongString.encodeLongString))))(new Data_Symbol.IsSymbol(function () {
    return "email";
}))(Foreign_Generic_Class.encodeWithOptionsOther(Shared_Type_ShortString.encodeShortString)))(new Data_Symbol.IsSymbol(function () {
    return "bio";
}))(Foreign_Generic_Class.encodeWithOptionsOther(Foreign_Generic_Class.maybeEncode(Shared_Type_LongString.encodeLongString)))))))))({
